...
public class Lista1Exercicio7 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Informe o número D: ");
		numD = teclado.nextDouble();
		System.out.println("Informe o número E: ");
		numE = teclado.nextDouble();
		System.out.println("Informe o número F: ");
		numF = teclado.nextDouble();
		
		numX = ((numC*numE) - (numB*numF)) / ((numA*numE) - (numB - numD));
		numY = ((numA*numF) - (numC-numD)) / ((numA*numE) - (numB - numD));
		
		System.out.printf("O valor de X é: %.2f", numX);
		System.out.printf("O valor de Y é: %.2f", numY);
